...
<head>
	...
	<title>Admin| Maintenance SubCategory</title>
...
<label class="control-label" for="basicinput">Maintenance Category</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Maintenance SubCategory</label>
<div class="controls">
<input type="text" placeholder="Enter Maintenance SubCategory"  name="subcategory" class="span8 tip" required>
</div>
</div>
