...
<html lang="en">
  <head>
    ...
    <title>TMS | Request Details</title>
...
<label class="col-sm-2 col-sm-2 control-label"><b>Sub Category :</b> </label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Request Type :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['complaintType']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Rental :</b></label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Nature of request :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Request Details </label>
              <div class="col-sm-10">
