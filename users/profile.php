...
<html lang="en">
  <head>
    ...
    <title>TMS | User Change Password</title>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Contact (254)</label>
 <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Rental</label>
<div class="col-sm-4">
...
<div class="col-sm-4">
<input type="text" name="country" required="required" value="<?php echo htmlentities($row['country']);?>" class="form-control" readonly>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="pincode" maxlength="8" required="required" value="<?php echo htmlentities($row['pincode']);?>" class="form-control" readonly>
</div>
