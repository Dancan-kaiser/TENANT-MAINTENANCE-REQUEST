...
<html lang="en">
  <head>
    ...
    <title>TMS | User Register Complaint</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> File your request</h3>
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Emergency Request</option>
                  <option value="General Query">General Request</option>
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Brief explanation (max 2000 words) </label>
<div class="col-sm-6">
